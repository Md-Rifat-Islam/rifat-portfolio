...
const projects = [
    {
        ...
        category: "frontend",
        title: "project 1",
        description: "jfkjshfdkjs sfj sfjk kjda fdsnzk j kjdd  fjjfajk",
                ...
                <div className="flex flex-col xl:flex-row xl:gap[30px]">
                    ...
                    xl:order-none">
                        <div className="flex flex-col gap-[30px] h-[50%]">
                            ...
                            {/* project category */}
                            <h2 className="text-[42px] font-bold leading-on text-white 
                    ...
                    <div className="w-full xl:w-[50%]">
                        ...
                        >
                            ...
                            <WorkSliderBtns 
                                ...
                                bottom-[calc(50%_-_22px)] xl:botton-0 z-20 w-full justify-between 
